...
--
-- Host: localhost
-- Generation Time: Jun 27, 2025 at 12:27 PM
...
(1, '2025-06-25', 'ngoding sampai sukses', 'pala gua muter', 1);
...
INSERT INTO `jurnal_kegiatan` (`id_jurnal_kegiatan`, `nama_pekerjaan`, `perencanaan_kegiatan`, `pelaksanaan_kegiatan`, `catatan_instruktur`, `siswa_id`) VALUES
(5, 'projek lumpuh', 'ngoding pagi malem', 'membuat web pkl', 'gasss terus', 1);
...
--
ALTER TABLE `jurnal_harian`
  MODIFY `id_jurnal_harian` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `jurnal_kegiatan`
--
ALTER TABLE `jurnal_kegiatan`
  MODIFY `id_jurnal_kegiatan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `siswa`
  MODIFY `id_siswa` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
