        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card shadow-lg">
                        ...
                        <div class="card-body p-4">
                            <form action="master_guru_pendamping_edit_act.php" method="POST">
                                <input type="hidden" name="id_pembimbing" value="<?= htmlspecialchars($data['id_pembimbing']) ?>">

                                <div class="mb-3">
                                    <label class="form-label fw-bold">Nama Guru</label>
                                    <input type="text" name="nama_pembimbing" class="form-control" required value="<?= htmlspecialchars($data['nama_pembimbing']) ?>">
                                </div>

                                <div class="mb-3">
                                    <label class="form-label fw-bold">NIP</label>
                                    <input type="text" name="nip" class="form-control" required   value="<?= htmlspecialchars($data['nip']) ?>">
                                </div>
                    ...
                    <a href="master_guru_pendamping.php" class="btn btn-primary mt-3"><i class="bx bx-left-arrow-alt"></i> Kembali ke daftar</a>
                    <?php endif; ?>
