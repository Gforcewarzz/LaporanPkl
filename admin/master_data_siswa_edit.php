                            ...
                            <div class="card-body p-4">
                                <form action="master_data_siswa_edit_act.php" method="POST">
                                    <input type="hidden" name="id_siswa"
                                        value="<?= htmlspecialchars($data['id_siswa']) ?>">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="no_induk" class="form-control" required
                                            value="<?= htmlspecialchars($data['no_induk']) ?>">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="guru_nama" class="form-control" list="datalistGuru"
                                            required value="<?= htmlspecialchars($data['nama_pembimbing']) ?>">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="tempat_pkl_nama" class="form-control"
                                            list="datalistTempatPKL" required
                                            value="<?= htmlspecialchars($data['nama_tempat_pkl']) ?>">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="status" class="form-select" required>
                                            ...
                                            <option value="Tidak Aktif"
                                                <?= $data['status'] === 'Tidak Aktif' ? 'selected' : '' ?>>Tidak Aktif
                                            </option>
                                            <option value="Selesai"
                                                <?= $data['status'] === 'Selesai' ? 'selected' : '' ?>>Selesai</option>
                                        </select>
                                    </div>

                                    <!-- ✅ Tambahkan bagian untuk ubah password -->
                                    <div class="mb-3">
                                        <label class="form-label fw-bold">Password (Kosongkan jika tidak ingin
                                            mengganti)</label>
