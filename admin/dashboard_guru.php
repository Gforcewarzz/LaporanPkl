...
$total_laporan_harian_bimbingan = 0; // Inisialisasi
$total_tugas_proyek_bimbingan = 0;   // Inisialisasi
...
// Query untuk menghitung total laporan kegiatan harian dari siswa bimbingan
// FIX: Menggunakan id_jurnal_harian
...
if ($stmt_laporan_harian_bimbingan) {
    ...
    $hasil_laporan_harian_bimbingan = $stmt_laporan_harian_bimbingan->get_result();
    $data_laporan_harian_bimbingan = $hasil_laporan_harian_bimbingan->fetch_assoc();
    $total_laporan_harian_bimbingan = $data_laporan_harian_bimbingan['total_laporan'] ?? 0;
    $stmt_laporan_harian_bimbingan->close();
} else {
    error_log("Error preparing total_laporan_harian_bimbingan query: " . $koneksi->error);
}

// Query untuk menghitung total laporan tugas proyek dari siswa bimbingan
...
if ($stmt_tugas_proyek_bimbingan) {
    ...
    $hasil_tugas_proyek_bimbingan = $stmt_tugas_proyek_bimbingan->get_result();
    $data_tugas_proyek_bimbingan = $hasil_tugas_proyek_bimbingan->fetch_assoc();
    $total_tugas_proyek_bimbingan = $data_tugas_proyek_bimbingan['total_tugas'] ?? 0;
    $stmt_tugas_proyek_bimbingan->close();
} else {
    error_log("Error preparing total_tugas_proyek_bimbingan query: " . $koneksi->error);
}
...
// Query untuk data grafik tren absensi mingguan
$chart_data = [];
...
// Query SQL untuk absensi mingguan siswa bimbingan
                                ...
                                <div class="card bg-gradient-primary-to-secondary text-white shadow-lg border-0"
                                    ...
                                    <div class="card-body p-5 position-relative">
                                        ...
                                        <div class="position-absolute bottom-0 end-0 p-3" style="opacity: 0.1;">
                                            <i class="bx bx-bar-chart-alt-2 bx-lg"
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div
                                    ...
                                    <div class="card-body d-flex flex-column align-items-start p-4">
                                        ...
                                        <span class="text-muted fw-semibold d-block mb-1 fs-6">Total Siswa
                                            Bimbingan</span>
                                        <h3 class="card-title fw-bold mb-0 display-5 text-dark">
                                            <?= $total_siswa_bimbingan ?></h3>
                                        <small class="text-muted d-block mt-1" style="font-size: 0.85rem;">Siswa aktif
                                            di bawah bimbingan Anda</small>
                                        <a href="master_data_siswa.php?pembimbing_id=<?= $guru_id ?>"
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div
                                    ...
                                    <div class="card-body d-flex flex-column align-items-start p-4">
                                        ...
                                        <span class="text-muted fw-semibold d-block mb-1 fs-6">Absensi Siswa Hari
                                            Ini</span>
                                        <h3 class="card-title fw-bold mb-0 display-5 text-dark">
                                            <?= $total_absen_hari_ini ?></h3>
                                        <small class="text-muted d-block mt-1" style="font-size: 0.85rem;">Siswa yang
                                            telah melakukan absensi hari ini</small>
                                        <a href="master_data_absensi_siswa.php?pembimbing_id=<?= $guru_id ?>&tanggal=<?= $today_date ?>"
                        ...
                        <div class="row g-4 mt-2">
                            <div class="col-lg-6 col-md-6 col-12">
                                <div
                                    ...
                                    <div class="card-body d-flex align-items-center justify-content-between p-4">
                                        <div>
                                            ...
                                            <h3 class="fw-bold mb-0 display-5 text-dark">
                                                <?= $total_laporan_harian_bimbingan ?>
                                            </h3>
                                    ...
                                    <div class="card-footer bg-light text-end">
                                        <a href="master_kegiatan_harian.php?pembimbing_id=<?= $guru_id ?>"
                                            class="btn btn-sm btn-outline-info">Lihat Jurnal <i
                                                class="bx bx-chevron-right"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-12">
                                <div
                                    ...
                                    <div class="card-footer bg-light text-end">
                                        <a href="master_tugas_project.php?pembimbing_id=<?= $guru_id ?>"
                                            class="btn btn-sm btn-outline-danger">Lihat Tugas <i
                                                class="bx bx-chevron-right"></i></a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted text-center mt-3 mb-0" style="font-size: 0.85rem;">Grafik
                                            menunjukkan jumlah siswa bimbingan Anda yang melakukan absensi setiap hari.
                                        </p>
                                    </div>
                                </div>
                            </div>
