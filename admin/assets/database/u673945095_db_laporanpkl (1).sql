...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 11 Jul 2025 pada 04.38
...
CREATE TABLE `jurnal_kegiatan` (
  `id_jurnal_kegiatan` int(11) NOT NULL,
  `nama_pekerjaan` varchar(100) DEFAULT NULL,
  `perencanaan_kegiatan` text DEFAULT NULL,
...
(338, 'MIADI MOTOR', 'JL. Raya Cimalaka No.138 Sumedang', '-', '-', 10, 3),
(339, 'AZMI CAR', '', '', '', 4, 3),
...
(365, 'LKP Execom Haurgeulis', '', '', '', 10, 2),
...
(404, 'BPN Subang', '  ', ' ', '   ', 2, 1),
(406, 'PT PLN (PERSERO) HAURGEULIS ', 'Jl. Jenderal Sudirman, Cipancuh Kec. Haurgeulis Kab. Indramayu, 45264', 'NULL', 'NULL', 1, 1),
(407, 'Kantor Pertanahan Kab. Sumedang - ATR/BPN', 'Jl. Pangeran Kornel No.264, Pasanggrahan Baru, Kec. Sumedang Sel., Kab. Sumedang, 45311', 'NULL', 'NULL', 1, 1),
(408, 'Kantor Pertanahan Kab. Subang', 'Jl. Mayjen Sutoyo Siswomiharjo No.44, Karanganyar, Kec. Subang, Kab. Subang, 41211', 'NULL', 'NULL', 1, 1);
...
--
ALTER TABLE `guru_pembimbing`
  MODIFY `id_pembimbing` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT untuk tabel `jurnal_harian`
--
ALTER TABLE `jurnal_harian`
  MODIFY `id_jurnal_harian` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=253;

--
-- AUTO_INCREMENT untuk tabel `jurnal_kegiatan`
--
ALTER TABLE `jurnal_kegiatan`
  MODIFY `id_jurnal_kegiatan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;
...
--
ALTER TABLE `siswa`
  MODIFY `id_siswa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=403;

--
-- AUTO_INCREMENT untuk tabel `tempat_pkl`
--
ALTER TABLE `tempat_pkl`
  MODIFY `id_tempat_pkl` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=409;
