                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div
                            ...
                            <i class="fas fa-chalkboard-teacher fa-2x text-info animate__animated animate__fadeInRight"
                                style="opacity: 0.6;"></i>
                        </div>
                                ...
                                <div
                                    ...
                                    <div class="col-12 col-md-8 mb-2 mb-md-0">
                                        <input type="text" class="form-control"
                                            placeholder="Cari guru berdasarkan nama, NIP, atau bidang keahlian..."
                                            aria-label="Search" />
                                    </div>
                                    <div class="col-12 col-md-4 text-md-end">
                                        <button class="btn btn-outline-dark w-100 w-md-auto"><i
                                                class="bx bx-filter-alt me-1"></i> Filter Guru</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <small class="text-muted">Informasi detail seluruh guru</small>
                            </div>
                                ...
                                <div class="d-md-none p-3">
                                    ...
                                    <div
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-2">
                                                <strong class="text-dark"><i class="bx bx-chalkboard me-1"></i> Bidang
                                                    Keahlian:</strong><br>
                                    ...
                                    <div
                                        class="card mb-4 shadow-lg border-start border-4 border-success rounded-3 animate__animated animate__fadeInUp animate__delay-0-3s">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-start mb-3">
                                                <div>
                                    ...
                                    <div class="alert alert-info text-center mt-5 py-4 animate__animated animate__fadeInUp animate__delay-0-4s"
