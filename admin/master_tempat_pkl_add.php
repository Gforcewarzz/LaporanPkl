            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="card bg-gradient-primary-to-secondary text-white mb-4 shadow-lg"
                        ...
                        <div class="card-body p-4 d-flex justify-content-between align-items-center flex-column flex-sm-row">
                        ...
                        <div class="card-body p-4">
                            <form action="master_tempat_pkl_add_act.php" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_perusahaan" name="nama_perusahaan" placeholder="Contoh: PT. Inovasi Digital" required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Contoh: Jl. Merdeka No. 123, Bandung" required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="tel" class="form-control" id="kontak" name="kontak" placeholder="Contoh: (022) 1234567" pattern="[0-9() -+]{7,20}" required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="kuota_siswa" name="kuota_siswa" min="0" required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_instruktur_lapangan" name="nama_instruktur_lapangan" placeholder="Contoh: Bpk. Joni Iskandar">
                                </div>
                                ...
                                <div class="d-flex flex-column flex-sm-row justify-content-end gap-2">
                                    <a href="master_tempat_pkl.php" class="btn btn-outline-secondary w-100 w-sm-auto">
