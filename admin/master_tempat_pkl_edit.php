            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4 pb-2 border-bottom position-relative">
                        <h4 class="fw-bold mb-0 text-primary"><span class="text-muted fw-light">Master /</span> Edit Tempat PKL</h4>
                    </div>

                    <?php if ($placeData): ?>
                    <form action="master_tempat_pkl_edit_act.php" method="POST" class="card p-4 shadow-lg">
                        <input type="hidden" name="id_tempat_pkl" value="<?= htmlspecialchars($placeData['id_tempat_pkl']) ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="kuota_siswa" name="kuota_siswa"
                                   min="0" value="<?= htmlspecialchars($placeData['kuota_siswa']) ?>" required>
                        </div>
