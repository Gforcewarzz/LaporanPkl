                            ...
                            <div
                                ...
                                <div class="text-center text-sm-end position-relative">
                                    <div class="rounded-circle bg-white d-flex justify-content-center align-items-center animate__animated animate__zoomIn animate__delay-0-5s"
                                        ...
                                        <i class="bx bx-user-check bx-lg text-primary"
                                ...
                                <div
                                    ...
                                    <div class="col-12 col-md-4 text-md-end">
                                        <button class="btn btn-outline-dark w-100 w-md-auto"><i
                                                class="bx bx-filter-alt me-1"></i> Filter Siswa</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="d-md-none p-3">
                                    ...
                                    <div class="alert alert-info text-center mt-5 py-4 animate__animated animate__fadeInUp animate__delay-0-4s"
                                        ...
                                        <p class="mb-3">Belum ada data siswa yang tercatat di sini.</p>
                                        <p class="mb-0">
                                            Ayo, <a href="master_data_siswa_add.php"
                                                class="alert-link fw-bold">tambahkan data siswa pertama Anda</a>
                                            sekarang!
                                        </p>
                                    </div>
                                </div>
