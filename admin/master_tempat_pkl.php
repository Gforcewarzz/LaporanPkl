                        ...
                        <div class="card-footer bg-light border-top p-3">
                            <div class="row align-items-center">
                                <div class="col-md-8 mb-2 mb-md-0">
                                    <input type="text" class="form-control" placeholder="Cari Tempat Pkl Berdasarkan Nama Tempat atau nama instruktur....">
                                </div>
    ...
    <script>
        function confirmDeleteTempatPKL(id, namaPerusahaan) {
            Swal.fire({
                ...
                html: "Apakah Anda yakin ingin menghapus data tempat PKL <strong>" + namaPerusahaan + "</strong>?<br>Tindakan ini tidak dapat dibatalkan!",
                icon: 'warning',
